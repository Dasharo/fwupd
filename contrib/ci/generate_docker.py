    ...
    for line in lines:
        if line.startswith("FROM %%%ARCH_PREFIX%%%"):
            ...
            if OS == "fedora":
                ...
                #tss2-esys install
                wfd.write("RUN apt install -yq autoconf autoconf-archive automake build-essential g++ gcc libc6-dev git libssl-dev libtool m4 net-tools pkg-config libjson-c-dev libcurl-dev\n")
